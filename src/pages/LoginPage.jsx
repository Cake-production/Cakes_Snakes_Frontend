...
const LoginPage = ({ onLoginSuccess }) => {
  ...
  const handleLogin = (role) => {
    ...
    setTimeout(() => {
      ...
      localStorage.setItem('authToken', 'mock_token_' + Math.random());
      setIsLoading(false);
      onLoginSuccess();
    }, 800);
  };
      ...
      <div className="w-full max-w-md relative z-10">
        <div style={{ 
          ...
          <div className="text-center mb-8">
            <h1 style={{ fontFamily: 'Playfair Display, serif', fontSize: '32px', color: colors.darkPlum }} className="font-bold mb-2">
              Cakes & Snacks
            </h1>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  style={{ backgroundColor: colors.champagne, borderColor: colors.gold }}
                  className="w-full px-4 py-3 border-2 rounded-lg focus:outline-none pr-10"
                />
                <button
                  type="button"
