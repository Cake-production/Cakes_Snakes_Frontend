          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2">
              <div style={{ backgroundColor: 'white', borderRadius: '12px', overflow: 'hidden' }} className="shadow-md">
                {items.map((item, idx) => (
                  ...
                  >
                    <div style={{ backgroundColor: colors.champagne, fontSize: '60px' }} className="w-24 h-24 rounded flex items-center justify-center flex-shrink-0">
                      {item.image}
                    </div>
                    <div className="flex-1">
                      ...
                      <div className="flex justify-between items-center">
                        <span style={{ color: colors.gold }} className="text-lg font-bold">
                          ${item.price}
                        </span>
                        <button
            ...
            <div>
              <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '12px' }} className="shadow-md">
                ...
                <div className="space-y-3 mb-6 pb-6" style={{ borderBottomColor: colors.gold }} className="border-b">
